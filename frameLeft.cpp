...
#define FRAMELEFT_VERTEX_MAX	( 4 )	/*最高頂点数*/

#define FRAMELEFT_ANIM_MAX		( 1 )	/*アニメーションコマ数*/
#define FRAMELEFT_ANIM_SPAN	( 30 )	/*アニメーション間隔*/
#define FRAMELEFT_ANIM_DIV_X	( 1 )	/*幅分割数*/
#define FRAMELEFT_ANIM_DIV_Y	( 1 )	/*高さ分割数*/

#define FRAMELEFT_OUTPUT_SIZE	( 1 ) /*初期表示倍率*/ 
...
* グローバル変数
*******************************************************************************/
static LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffframeLeft = NULL;	/*頂点バッファ*/
static LPDIRECT3DTEXTURE9 g_pTextureframeLeft;	/*フレーム画像のテクスチャのポインタ*/
