...
#define AF_GAMEOVER_VERTEX_MAX	( 4 )	/*最高頂点数*/

#define AF_GAMEOVER_OUTPUT_POS_X	( SCREEN_WIDTH * 0.5 )		/*表示X座標*/
#define AF_GAMEOVER_OUTPUT_POS_Y	( SCREEN_HEIGHT * 0.5 )		/*表示Y座標*/

#define AF_GAMEOVER_ANIM_MAX		( 1 )	/*アニメーションコマ数*/
#define AF_GAMEOVER_ANIM_SPAN		( 0 )	/*アニメーション間隔*/
#define AF_GAMEOVER_ANIM_DIV_X	( 1 )	/*幅分割数*/
#define AF_GAMEOVER_ANIM_DIV_Y	( 1 )	/*高さ分割数*/

#define AF_GAMEOVER_OUTPUT_SIZE	( 1 ) /*初期表示倍率*/ 
...
* グローバル変数
*******************************************************************************/
static LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffAfGameOver = NULL;	/*頂点バッファ*/
static LPDIRECT3DTEXTURE9 g_pTextureAfGameOver;	/*ポーズグラフィックテクスチャのポインタ*/
...
static int fade = 0;
/*******************************************************************************
* 関数名	:HRESULT InitAfGameOver( void )
*		ポーズグラフィック初期化関数です。
* 引数		:void 引数なし
* 戻り値	:HRESULT 関数の実行結果
...
/*******************************************************************************
* 関数名	:void UninitAfGameOver( void )
*		ポーズグラフィック終了処理関数です。
* 引数		:void 引数なし
* 戻り値	:void 戻り値なし
...
/*******************************************************************************
* 関数名	:void UpdateAfGameOver( void )
*		ポーズグラフィック更新処理関数です。
* 引数		:void 引数なし
* 戻り値	:void 戻り値なし
