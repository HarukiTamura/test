...
* マクロ定義
*******************************************************************************/
#define BACKSKY_USE_TRIANGLE_NUM		( 16 )	//使用三角形数
#define USE_VERTEX_NUM	( BACKSKY_USE_TRIANGLE_NUM + 2 )		//使用頂点数
...
/*******************************************************************************
* 関数名	:HRESULT InitAfBackSky( void )
*		背景初期化関数です。
* 引数		:void 引数なし
* 戻り値	:HRESULT 関数の実行結果
...
void UpdateAfBackSky( void )
{
	...
	pVtx[0].col = D3DCOLOR_RGBA( 122 , 122 , 255 , 22 );	//頂点カラー設定
	pVtx[0].tex = D3DXVECTOR2( 0.0f , 0.0f );		//テクスチャ座標設定
