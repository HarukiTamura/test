...
* マクロ定義
*******************************************************************************/
#define AF_RESULT_GRAPHIC_VERTEX_MAX	( 4 )	/*最高頂点数*/

#define AF_RESULT_GRAPHIC_OUTPUT_POS_X	( SCREEN_WIDTH * 0.5 )		/*表示X座標*/
#define AF_RESULT_GRAPHIC_OUTPUT_POS_Y	( SCREEN_HEIGHT * 0.5 )		/*表示Y座標*/

#define AF_RESULT_GRAPHIC_ANIM_MAX		( 1 )	/*アニメーションコマ数*/
#define AF_RESULT_GRAPHIC_ANIM_SPAN		( 0 )	/*アニメーション間隔*/
#define AF_RESULT_GRAPHIC_ANIM_DIV_X	( 1 )	/*幅分割数*/
#define AF_RESULT_GRAPHIC_ANIM_DIV_Y	( 1 )	/*高さ分割数*/

#define AF_RESULT_GRAPHIC_OUTPUT_SIZE	( 1 ) /*初期表示倍率*/ 
...
* グローバル変数
*******************************************************************************/
static LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffAfResultGraphic = NULL;	/*頂点バッファ*/
static LPDIRECT3DTEXTURE9 g_pTextureAfResultGraphic;	/*リザルトグラフィックテクスチャのポインタ*/
